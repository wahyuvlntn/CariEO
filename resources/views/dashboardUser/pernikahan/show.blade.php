        ...
        <nav>
          <div class="container">
            <ol>
              ...
              <li><a href="/dashboardUser/pernikahan">Pernikahan</a></li>
              <li>Pemesanan</li>
            </ol>
          </div>
        </nav>
            ...
            <div class="row">
                    ...
                    <div data-bs-spy="scroll"data-bs-offset="0" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
                        <article class="blog-details">
                            <div class="post-img d-flex justify-content-center mt-1">
                                <img src="/img/home/wedding1.jpg" alt="" class="img-fluid rounded">
                            </div>
                ...
                <div class="col-4">
                    <div class="sidebar">
                        ...
                        <form action="/dashboardUser/pernikahan" method="POST">
                        @csrf
                            ...
                            <ul class="mt-4">
                                ...
                                <input type="hidden" id="idproduk" name="idproduk" value={{ $produk->id_produk }}>
                            </ul>
