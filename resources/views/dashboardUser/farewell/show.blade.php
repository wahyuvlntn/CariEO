        ...
        <nav>
          <div class="container">
            <ol>
              ...
              <li><a href="/dashboardUser/farewell">Farewell Party</a></li>
              <li>Pemesanan</li>
            </ol>
          </div>
        </nav>
            ...
            <div class="row">
                    ...
                    <div data-bs-spy="scroll"data-bs-offset="0" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
                        <article class="blog-details">
                            <div class="post-img d-flex justify-content-center mt-1">
                                <img src="/img/home/farewell.jpg" alt="" class="img-fluid rounded">
                            </div>
                ...
                <div class="col-4">
                    <div class="sidebar">
                        ...
                        <form action="/dashboardUser/konser" method="POST">
                        @csrf
